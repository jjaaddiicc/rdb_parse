...
/**
 * LZF compress & decompress method<br>
 * @see <a href="http://www.java2s.com/Code/Java/Collections-Data-Structure/implementstheLZFlosslessdatacompressionalgorithm.htm">lzf</a>
 * @created 2014-5-20
 */
public final class LZF {
    ...
    /**
     * decompress a number of compressed bytes.
     *
     ...
     */
    public static void decompress(byte[] in, int inPos, int inLen, byte[] out, int outPos, int outLen) {
