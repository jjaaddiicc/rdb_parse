...
public class ZSetZipList {
    ...
    private Map<byte[], Double> elements;
    
    public ZSetZipList(byte[] ziplistBuf) {
        this.buf = ziplistBuf;
        this.isParsed = false;
        this.elements = new HashMap<byte[], Double>();
    }
    ...
    private void parseElements() {
        ...
        for (int i = 0; i < elementsCount; i ++) {
            ...
            if (member == null) {//member
                ...
                elements.put(member, Double.parseDouble(new String(element)));
                member = null;
            }
        }
    }
     ...
     * @return
     */
    public Map<byte[], Double> getElements() {
        this.parseElements();
        return elements;
    }
